...
public class BreakFast_Display extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_break_fast__display);
        ...
        submit1= findViewById(R.id.st_button);
        ...
        submit1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ref= FirebaseDatabase.getInstance().getReference("Lunch").child("Break Fast").child(currentDate).child(id);
                BreakFastData bf=new BreakFastData(name,id,slot,item,currentTime);
                ref.setValue(bf);
                Intent intent=new Intent(BreakFast_Display.this,LunchHome.class);
