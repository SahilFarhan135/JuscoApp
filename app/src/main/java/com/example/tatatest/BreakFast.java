...
public class BreakFast extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slot1= findViewById(R.id.lSlot1);
        slot2= findViewById(R.id.lSlot2);
        slot3= findViewById(R.id.lSlot3);
        slot4= findViewById(R.id.lSlot4);
        ...
        slot1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ref= FirebaseDatabase.getInstance().getReference("Lunch").child("Lunch").child(currentDate).child("slot1");
                ref.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.hasChildren()){
                            ...
                            if(ChildValue<=20){
                                Intent intent=new Intent(BreakFast.this,lunch_2.class);
